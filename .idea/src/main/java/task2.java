...
public class task2 {
    //    Create a guessing game where you guess a number and computer try to guess it.
//    You write 0 – computer guessed your number, 1 – the number you have guessed is bigger, 2 – smaller
